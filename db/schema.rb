...
ActiveRecord::Schema[7.0].define(version: 2023_05_04_121629) do
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.jsonb "mastodon_account"
    t.string "instance"
    t.datetime "crowled_at"
    ...
    t.text "address"
    t.datetime "request_remove_at"
    t.index ["region_id"], name: "index_accounts_on_region_id"
    t.index ["team_id"], name: "index_accounts_on_team_id"
    t.index ["topic_id"], name: "index_accounts_on_topic_id"
  end

  create_table "accounts_topics", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "topic_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_accounts_topics_on_account_id"
    t.index ["topic_id"], name: "index_accounts_topics_on_topic_id"
  end
  ...
  add_foreign_key "accounts", "memberships", column: "topic_id"
  add_foreign_key "accounts", "regions"
  add_foreign_key "accounts", "teams"
  add_foreign_key "accounts_topics", "accounts"
  add_foreign_key "accounts_topics", "topics"
